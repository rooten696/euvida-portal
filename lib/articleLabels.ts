...
export const categoryLabels: LabelMap = {
  cs: {
    ...
    lift: 'Lanovka & vlek',
    beginner: 'Pro začátečníky & rodiny',
    rental: 'Půjčovna & servis',
    trail_map: 'Mapa trailů',
  ...
  fr: {
    ...
    lift: 'Remontée & navette',
    beginner: 'Débutants & familles',
    rental: 'Location & atelier',
    trail_map: 'Plan des pistes',
  ...
  es: {
    ...
    lift: 'Remonte y shuttle',
    beginner: 'Principiantes y familias',
    rental: 'Alquiler y taller',
    trail_map: 'Mapa de pistas',
