    ...
    <footer className="bg-slate-900 text-slate-300 py-12 border-t border-slate-800 mt-auto">
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="col-span-1 md:col-span-2">
          <Link href={`/${locale}`} className="text-2xl font-extrabold text-white tracking-tighter inline-block mb-4 hover:opacity-80 transition-opacity">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm font-medium">
            <li><Link href={`/${locale}`} className="hover:text-yellow-400 transition-colors">Domů</Link></li>
            <li><Link href={`/${locale}/oblibene`} className="hover:text-yellow-400 transition-colors">Oblíbené destinace</Link></li>
            <li><Link href={`/${locale}/profile`} className="hover:text-yellow-400 transition-colors">Přihlášení a profil</Link></li>
          </ul>
        </div>
