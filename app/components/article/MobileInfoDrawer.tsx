  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 lg:hidden flex items-center gap-2 rounded-full bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black px-5 py-3.5 shadow-2xl hover:scale-105 active:scale-95 transition-all duration-200"
        aria-label={t.title}
      >
